...
#SUBU����  ѭ����1   revise date:2018/3/12 tiger
...
#LBU ����    revise date:2018/3/12 tiger#
...
#�������0x0000000f 0x0000000e 0x0000000d 0x0000000c 0x0000000b 0x0000000a 0x00000009 0x00000008 0x00000007 0x00000006 0x00000005 0x00000004 0x00000003 0x00000002 x00000001 x00000000
.text
addi $s1,$zero,15  #��ʼֵ
bgez_branch:
add $a0,$0,$s1          
