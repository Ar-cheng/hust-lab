...
//  %type 定义非终结符的语义值类型
%type  <ptr> program ExtDefList ExtDef  Specifier ExtDecList FuncDec CompSt VarList VarDec ParamDec Stmt StmList DefList Def DecList Dec Exp Args  StructSpecifier StructName
...
%token LB RB DPLUS DMINUS EXP_DPLUS EXP_DMINUS DPLUS_EXP DMINUS_EXP PLUS_ASSIGNOP MINUS_ASSIGNOP STAR_ASSIGNOP DIV_ASSIGNOP ARRAY_DEF ARRAY_READ BREAK CONTINUE DOT STRUCT STRUCT_READ
// [ ]  ++exp exp++ --exp exp-- += -= *= /=
